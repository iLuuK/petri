...
class Color(IColor, Data):
    ...
    def lighter(self, lightCoefficient: int):
        self.__red = min(255, self.__red + lightCoefficient * 3)
        self.__green = min(255, self.__green + lightCoefficient * 3)
        self.__blue = min(255, self.__blue + lightCoefficient * 3)
